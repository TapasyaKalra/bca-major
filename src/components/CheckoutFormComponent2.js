    ...
    const handleSubmit = async (event) => {
        ...
        if (payment === "COD") {
            ...
            const data = {
                ...
                email: user?.email,
                subject: "Order Confirmation",
                message: `Your order of ${content} of the amount, ₹${amount} has been confirmed. Mode of payment is Card. Further information will be shared with you once the order is shipped.`
            }
            emailjs.send('service_oct1hjp', 'template_jpat9wi', data, 'Kcux1VYvqoaedA6Sq')
                .then((result) => {
                    console.log(result.text);
    ...
    return(
            ...
            <div className = "container">
                ...
                <Form className = "mt-5 mb-5">
                    ...
                    <div className = "col-12 col-md-6">
                        <FormGroup check>
                                <Input value="COD" type="radio" name="payment" id="cod" onChange = {e => setPayment(e.target.value)} onClick={(e) => radioHandler(0)}/>
                                <Label htmlFor="cod">COD</Label>
                            </FormGroup>
                            <FormGroup check>
                                <Input value="UPI" type="radio" name="upi" id="upi" checked={status === 2} onChange = {e => setPayment(e.target.value)} onClick={(e) => radioHandler(2)}/>
                                <Label htmlFor="upi">UPI</Label>
                            </FormGroup>
                            <FormGroup check>
                                <Input value="Card" type="radio" name="payment" id="card" onChange={e => setPayment(e.target.value)}
                            ...
                            {status === 2 && (<>
                                <img alt="QR" src="assets/images/QR.jpg" id="QR"/>
                            </>)}
